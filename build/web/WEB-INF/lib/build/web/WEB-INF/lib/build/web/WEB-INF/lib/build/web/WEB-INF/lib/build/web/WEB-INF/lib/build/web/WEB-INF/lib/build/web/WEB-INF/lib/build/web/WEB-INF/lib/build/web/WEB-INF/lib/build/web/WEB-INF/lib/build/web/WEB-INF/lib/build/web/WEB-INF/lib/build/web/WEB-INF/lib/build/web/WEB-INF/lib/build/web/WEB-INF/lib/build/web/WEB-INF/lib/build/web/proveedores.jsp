                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a class="btn btn-warning" href=""><img src="img/modify.png" alt="Profile Icon">Modificar</a>
                                    <a class="btn btn-danger" href="javascript:void(0);" onclick="confirmDelete(<%=pro.getProvid()%>);"><img src="img/delete.png" alt="Profile Icon">Eliminar</a>
                                </td>
                            </tr>      
                            <%
                                }
